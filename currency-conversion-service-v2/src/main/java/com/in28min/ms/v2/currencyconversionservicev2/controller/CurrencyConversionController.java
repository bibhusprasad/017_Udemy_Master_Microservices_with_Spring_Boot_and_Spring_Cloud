...
import com.in28min.ms.v2.currencyconversionservicev2.service.CurrencyExchangeProxy;
...
public class CurrencyConversionController {
    ...
    public CurrencyConversion calculateCurrencyConversionFeign(
        ...
        final CurrencyConversion currencyConversion = this.proxy.retrieveExchangeValue(from, to);
